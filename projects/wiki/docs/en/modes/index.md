...
Morimens offers a variety of game modes spanning combat, exploration, PvP, crafting, and more.

## Mode Overview

| Mode | Type | Description | Unlock |
|------|------|-------------|--------|
...
### Combat Modes
- [Combat System](./combat.md) -- Core turn-based card battle mechanics
- [Investigation](./investigation.md) -- Roguelite hex-map exploration
- [Phase Chess](./phase-chess.md) -- Fair PvP with no stat differences

### Progression Modes
- [Consciousness Dive](./consciousness-dive.md)
- [Dream Visions](./dream-visions.md)
- [Proliferation Frenzy](./proliferation.md)

### Utility Modes
- [Gacha / Summoning](./gacha.md) -- Pull for Awakeners and equipment
- [Smelting Room](./smelting.md) -- Craft items and materials
- [Dispatch](./dispatch.md) -- Idle resource gathering
