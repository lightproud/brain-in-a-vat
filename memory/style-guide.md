...
|主文字   |`#f0ebe0`              |正文主文字           |
|辅助文字  |`#b5aa98`              |次要信息、英文副标题      |
|弱文字   |`#7a7264`              |页码、注释、签名        |
|面板底色  |`#111219`              |卡片/面板背景色        |
|面板表头  |`#16171f`              |表头背景色           |
|行分割线  |`#1e1f2a`              |表格边框、分隔线        |
...
|用途    |色值        |说明                   |
|------|-----------|-----------------------|
|正文    |`#d4c9a8`  |PDF/报告等暖色文档正文文字      |
|辅助文字  |`#6b6040`  |PDF 页码、注释、签名           |
|卡片/表头底|`#1e1a10`  |暖棕黑，PDF 表头背景、卡片底色     |
|边框    |`#2a2515`  |PDF 表格边框、分隔线           |
|装饰线   |`#3a3520`  |PDF 低对比度装饰线、引用框边       |

### 游戏/角色主题色

|用途    |色值        |说明              |
|------|-----------|--------------------|
|混沌    |`#b07ee8`  |Chaos 界域角色主题色   |
|深海    |`#5ab4e8`  |Aequor 界域角色主题色  |
|血肉    |`#e86a5a`  |Caro 界域角色主题色    |
|超维    |`#f0d75a`  |Ultra 界域角色主题色   |

**绝对禁止**：纯白、纯灰。非游戏主题色的中性色必须偏暖偏棕。
